A WIP time capsule diary web application. Full stack JavaScript application built using MongoDB Atlas, Express, React, and Node.js. Additionally utilizing Next.js, Tailwind CSS, and the OpenAI API (gpt-4o-mini).
